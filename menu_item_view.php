...
include 'config.php';
if(isset($_GET['noo'])&& isset($_GET['no'])  ){
    $sql = "SELECT * from items where id=".$_GET['noo'];
...
<body>	
	...
	<header class="header">
		...
		<a href="menu_list.php?no=<?php echo $_GET['no']; ?>&cat=<?php echo $row['cat_id']; ?>" class="header-icon-2"><i class="fa fa-arrow-left"></i></a> 
	</header>
	...
	<div id="menu-sidebar" class="menu menu-sidebar">
		<div class="menu-scroll">
            ...
            <a class="menu-item" href="menu_home.php?no=<?php echo $_GET['no'];?>"><i class="fa fa-home active-icon"></i><span>الرئيسية</span></a>	
            <?php
            ...
            for($j=0; $j<$no_cat2 ;$j++){
                $row2 = mysqli_fetch_array($result2);
                    echo '<a class="menu-item" href="menu_list.php?no='.$_GET['no'].'&cat='.$row2['id'].'"><i class="fa fa-navicon"></i><span>'.$row2['name'].'</span></a>';
                if($row2['id']==$_GET['noo']){
                    $name=$row2['name'];
                }
            }            
			...
			<div class="content">
				...
				<div class="home-thumbnails home-1-thumbs">
                    ...
                    for($j=0;$j<$no_cat;$j++){
						...
						<u>$9.99</u>
						<strong class="color-black">'.$row['name'].'</strong>
                        <em>'.$row['note'].'</em>
