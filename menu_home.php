...
include 'config.php';
if(isset($_GET['no'])){
    $sql = "select * from pranches where id=".$_GET['no'];
...
<link rel="canonical" href="menu_home.php">
...
.cover-bg-1{background-image:url(images/menuphoto.jpg);}
...
.cover-logo{
	background-image:url(images/logopngw.png);
	width:300px;
	height:150px;
...
<!--	<input type="checkbox" id="toggle-menu">
	...
	<div class="page-content no-header">
		<div class="page-content-scroll">
			
			<div class="cover-class cover-bg-1">
				<div class="cover-content">
				
				</div>
				<a href="menu_categories.php?no=<?php echo $_GET['no'] ;?>" class="cover-cta">MENU</a>
