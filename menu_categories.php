...
include 'config.php';
if(isset($_GET['no'])){
    $sql = "SELECT * from categories , ( SELECT DISTINCT cat_id from items where EXISTS (SELECT item_id from item_pranch where pranch_id=".$_GET['no'].")) tt2 where categories.id=tt2.cat_id";
...
.home-thumbnails amp-img{border-radius:50%; overflow:hidden;}
...
<body>	
	...
	<header class="header">
		...
		<a href="menu_home.php?no=<?php echo $_GET['no'];?>" class="header-icon-2"><i class="fa fa-arrow-left"></i></a> 
	</header>
		...
		<div class="menu-scroll">
            ...
            for($j=0; $j<$no_cat ;$j++){
                $row = mysqli_fetch_array($result);
                    echo '<a class="menu-item" href="menu_list.php?no='.$_GET['no'].'&cat='.$row['id'].'"><i class="fa fa-navicon"></i><span>'.$row['name_en'].'</span></a>';
	...
	<div class="page-content no-header"  style="background-color:#333333;">
		<div class="page-content-scroll">
			<div class="decoration decoration-margins"></div>
			
			
			<div class="content">
				<h1 class="uppercase center-text ultrabold"></h1>
				...
				<div class="home-thumbnails home-2-thumbs">
                   ...
                   for($j=0; $j<$no_cat ;$j++){
                    $row = mysqli_fetch_array($result);
                    echo ' 
                <a href="menu_list.php?no='.$_GET['no'].'&cat='.$row['id'].'">
                    <u>$9.99</u>
                    <strong class="color-black">'.$row['name_en'].' <br> '.$row['name'].'</strong>
                   
                </a>
                <a href="menu_list.php?no='.$_GET['no'].'&cat='.$row['id'].'">
                    <amp-img src="images/catag/'.$row['image'].'" width="200" height="200" layout="responsive"></amp-img>
