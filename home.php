			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-3 align-items-start">
					<div class="mr-auto d-none d-lg-block">
						<h2 class="text-black font-w600 mb-0">لوحة التحكم</h2>
						<p class="mb-0">أهلا وسهلا بكم في لوحة التحكم </p>
					</div>
							...
							<div class="card-body p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										<h3 class="mb-0 text-black"><span class="counter ml-0"><?php echo $no_pranch;?></span></h3>
						...
						<div class="widget-stat card">
							<div class="card-body p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										<h3 class="mb-0 text-black"><span class="counter ml-0"><?php echo $no_categories;?></span></h3>
						...
						<div class="widget-stat card">
							<div class="card-body p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										<h3 class="mb-0 text-black"><span class="counter ml-0"><?php echo $no_items;?></span></h3>
										<p class="mb-0">الأصناف</p>
										<small></small>
									</div>
								</div>
							</div>
